...
#define f2i(A) ((A)>>8)
#define uf2i(A) (((unsigned int)(A))>>8)
#define i2f(A) ((A)<<8)
#define r2i(A) ((A)>>16)
...
typedef struct
{
  u32 pixels[YETI_VIEWPORT_HEIGHT][YETI_VIEWPORT_WIDTH];
} framebuffer_t;
#else
typedef struct
{
...
extern void start_snd(entity_t* e, u16 sfx);
extern void stop_snd(entity_t* e);
extern u16 check_snd(entity_t* e);
extern void update_snd(entity_t* e);
