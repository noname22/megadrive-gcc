...
void yeti_tick(yeti_t* yeti)
{
  ...
  yeti->keyboard._c       = yeti->keyboard.c;
  yeti->keyboard._start   = yeti->keyboard.start;
  ...
  yeti->keyboard._x       = yeti->keyboard.x;
  yeti->keyboard._y       = yeti->keyboard.y;
  yeti->keyboard._z       = yeti->keyboard.z;
  yeti->keyboard._mode    = yeti->keyboard.mode;
